...
<div class="contenedory">
    <div class="contendor-efecto">
        ...
        <p>Al utilizar este sitio web declaras que tienes al menos la mayoría de edad de tu estado o provincia de residencia, y que has dado tu consentimiento a ingeangel.com </p>
        <div class="titulo-seccion">
            <h1 id="sparklemaster" class="sparklemaster" style="color:  #93A9CC;">Sección 1: Responsabilidad del contenido de los proyectos.</h1>
        </div>
        ...
        <p>Toda la información que se encuentra en ingeangel.com a sido recolectada de las diversas fuentes que a lo largo del sitio web podrás ir encontrando, inclusive podrá buscar los temas que no le queden claros en fuentes externas al sitio. Por favor no haga un contrato sin antes haber consultado los medios que le den confianza a usted.</p>
        <p>En ingeangel.com subimos contenido con características exclusivas de programación, otro tipo de contenido podría estar no actualizada o errónea. Y nos reservamos el derecho de modificar el contenido de todo el sitio web. Y aceptas que es tu responsabilidad monitorear los cambios en nuestro sitio web.</p>
        <div class="titulo-seccion">
        ...
        <p>En el mercado hay un amplio abanico de dispositivos inteligentes desde los cuales se puede acceder a sitios web, ingeangel.com no garantiza una visualización perfecta en cada uno de ellos, y mucho menos que los colores coincidan con la visualización del proyecto en un software dedicado a la edición de sitios web. Por lo que los resultados variaran según sea el equipo que lo este visualizando. </p>
        <p>En ningún caso ingeangel.com y su equipo de programadores serán responsables por cualquier daño, perdida reclamo o daños directos, indirectos, incidentales, punitivos, especiales o consecuentes de ningún tipo, incluyendo, sin limitación, pérdida de beneficios  perdida de ingreso, perdida de ahorros, perdida de datos , costos de reemplazo, o cualquier daño similar, ya sea basada en contrato, agravio (incluido negligencia), responsabilidad  estricta o de otra manera, como consecuencia del uso de cualquiera de los servicios contratados mediante ingeangel.com o por cualquier otro reclamo relacionado de alguna manera con el uso del servicio, incluyendo pero no limitado a cualquier error u omisión en cualquier contenido o cualquier perdida o daño de cualquier tipo incurridos como resultados de la utilización del servicio  o cualquier contenido publicado, trasmitido o que se ponga a disposición a través de ingeangel.com incluso si se avisa de su posibilidad.</p>
        <p>Debido a que en algunos estados o jurisdicciones no permiten la exclusión de la responsabilidad de daños consecuenciales o incidentales en tales estados o jurisdicciones ingeangel.com y su equipo de programadores se limitara a responsabilizarse en la medida máxima permitida por la ley.</p>
        <div class="titulo-seccion">
            <h1 id="sparklemaster" class="sparklemaster" style="color:  #93A9CC;">Sección 14: Indemnización</h1>
        </div>
        <p>Aceptas indemnizar, defender y mantener indemne ingeangel.com y a su equipo de programadores de cualquier reclamo o demanda, incluyendo honorarios de abogados hecho por cualquier tercero a causa o como resultado de tu incumplimiento de las términos y condiciones de servicio o de los documentos que incorporan como referencia, o la violación de cualquier ley o de los derechos de terceros.</p>
        <div class="titulo-seccion">
        ...
        <p>Preguntas acerca de los Términos Y Condiciones de Servicio deben ser enviadas a info@ingeangel.com</p>
