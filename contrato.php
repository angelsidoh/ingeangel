...
?>
   ...
   $cadena_de_texto = $_GET['contrato'];
    ...
    $resultadoConsulta = consultaUsuarioContrato($vectorIdUsuarioProyectos[0]);
    if ($resultadoConsulta->num_rows) {
     ...
     $resultadoContratos = consultaContratosContrato($tokencontrato);
...
<div class="firmax"><img src="includes/funciones/doc_sings/eabf01667e80bd578beedf5d19d39f61.png" alt="">
