	...
	<div class="contenedory">
		<div style="text-align: justify;" class="contendor-efecto">
			<div style="text-align: center;" class="titulo-seccion">
				...
				<h2>Sitio web: https://www.ingeangel.com</h2>
			</div>
			<p>Mediante el sitio web <strong><u>https://www.ingeangel.com</u></strong>, el <strong><u>C. <?php echo $usuario . ' ' . $apellidos; ?></u></strong>, residente de la Calle: <strong><u><?php echo $calle; ?></u></strong> Número exterior:<strong><u> <?php echo $numie; ?></u></strong> Colonia: <strong><u><?php echo $col; ?></u></strong>, para dar inicio el proyecto web <strong><u><?php echo $vectorNombresProyectos[0]; ?></u></strong>
				El ingeniero en Mecatrónica <strong><u>José Angel Ruiz Chávez</u></strong>, residente de la calle: <strong><u>San José de la Mina</u></strong> Número Exterior: <strong><u>42</u></strong> colonia: <strong><u>San José de la Mina</u></strong>, responsable de <strong><u>https://www.ingeangel.com</u></strong> y sus servicios.
			...
			<p>1ª Cláusula. El propósito de este contrato para el <strong><u><?php echo $vectorTipoProyectos; ?></u></strong> del sitio web https://www.ingeangel.com; es proporcionar al proyecto web: <strong><u><?php echo $vectorNombresProyectos[0]; ?></u></strong> los siguientes servicios; <br></p>
			...
			<p>3ª Cláusula. Para la prestación de los servicios cubiertos por este contrato, el cliente pagará a <strong><u>https://www.ingeangel.com</u></strong> el monto <strong><u>
						<?php
			...
			<p>4ª Cláusula. En caso de incumplimiento por parte del C. <strong><u> <?php echo $usuario . ' ' . $apellidos; ?></u></strong> del proyecto web: <strong><u><?php echo $vectorNombresProyectos[0]; ?></u></strong>, con respecto al pago de renovación de contrato mencionado en la cláusula anterior, en los días descritos, habrá una multa de 10% del monto para la renovación de contrato y corrección monetaria en el monto adeudado. Y <strong><u>https://www.ingeangel.com</u></strong> puede, a su discreción, considerar reincidido el proyecto web: <strong><u><?php echo $vectorNombresProyectos[0]; ?></u></strong></p>
			<p>5ª Cláusula. En caso de que <strong><u>https://www.ingeangel.com</u></strong> demuestre una prestación de servicios deficiente el cliente propietario del proyecto web: <strong><u><?php echo $vectorNombresProyectos[0]; ?></u></strong> puede considerar reincidido este contrato.</p>
			...
			<p>7ª Cláusula. Se afirma que no tienen relación laboral entre C. <strong><u> <?php echo $usuario . ' ' . $apellidos; ?></u></strong> del proyecto web: <strong><u><?php echo $vectorNombresProyectos[0]; ?></u></strong> y <strong><u>https://www.ingeangel.com</u></strong> y su equipo de desarrolladores.</p>
			...
			?>
				...
				<div style="text-align: center;" class="firmax"><img style="width: 520px; height: auto; margin-top: 50px;margin-left: calc(50% - 260px);" src="includes/funciones/doc_sings/eabf01667e80bd578beedf5d19d39f61.png" alt="error: eabf01667e80bd578beedf5d19d39f61.png">
