...
try {
    ...
    if ($resultado != false) {
        ...
        $stmt = $conn->prepare('INSERT INTO pagoparts (id_pagoparts, idpago_pagoparts, tokencontrato_pagoparts, fecha_pagoparts,orderstatus_pagoparts,  monto_pagoparts) VALUES (null, :idpago_pagoparts, :tokencontrato_pagoparts, :fecha_pagoparts,:orderstatus_pagoparts, :monto_pagoparts)');
        $stmt->execute(array(
